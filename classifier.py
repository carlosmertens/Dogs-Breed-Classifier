"""Function to clasify images using CNN model."""
# !/usr/bin/env python3
# -*- coding: utf-8 -*-
# */Courses-Projects/Udacity/My_AIPND_Project1/classifier.py
#
# PROGRAMMER: Jennifer S. (Udacity Instuctor)
# DATE CREATED: Uploaded into my project 10/03/2018
...
#          usage below.
#
# USAGE: python classifier.py    -- will run program from commandline
...
def classifier(img_path, model_name):
    """Classify the image with prefer CNN model."""
    # load the image
