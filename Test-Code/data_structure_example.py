...
filename = ["Beagle_01141.jpg", "Beagle_01125.jpg", "skunk_029.jpg" ]
...
for idx in range(0, len(filename), 1):
    ...
    if filename[idx] not in results_dic:
        results_dic[filename[idx]] = [pet_labels[idx], classifier_labels[idx]]
...
for idx in range(0, len(filename), 1):
    ...
    results_dic[filename[idx]].append(pet_label_is_dog[idx])
    results_dic[filename[idx]].append(classifier_label_is_dog[idx])
